...
# filter
START_MESSAGE = 'Выберите до 4-х предметов.'
ANSWER_1_ERROR = 'Извините, вы не выбрали <b>ни одного предмета</b>. Повторите еще раз.'
ITEM_SELECTION = 'Вы выбрали {}'
DEF_FIND_ERROR_MESSAGE = 'Извините, по вашему запросу ({}) я не смог найти ни одного направления.'
...
ASK_CONTROLLER_GET = 'Отправляю вопросы\nВсего вопросов: {}'
ASK_CONTROLLER_QUESTION = 'Вопрос:\n{}'
ASK_MESSAGE = 'Ваш вопрос был отправлен'
# support_controller
